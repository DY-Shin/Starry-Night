      ...
      <motion.svg xmlns="http://www.w3.org/2000/svg" width="100px" height="100px" viewBox="0 0 700 700">
        ...
        <g fill="none" stroke="#7BD6CD" strokeMiterlimit="10" strokeWidth="41.791" clipPath="url(#z)">
          <motion.path
            ...
            d="m569.49 234.51h-335c-92.503 0-167.5 74.999-167.5 167.5 0 92.503 74.999 167.5 167.5 167.5 92.497 0 167.5-74.999 167.5-167.5 0-92.497 74.999-167.5 167.5-167.5 92.503 0 167.5 74.999 167.5 167.5 0 44.417-17.655 87.035-49.061 118.44"
          />
        </g>
      </motion.svg>
    </div>
