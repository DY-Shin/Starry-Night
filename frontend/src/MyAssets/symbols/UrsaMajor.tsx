      ...
      <motion.svg xmlns="http://www.w3.org/2000/svg" width="100px" height="100px" viewBox="0 0 700 700">
        ...
        <g fill="none" stroke="#7BD6CD" strokeMiterlimit="10" strokeWidth="41.791" clipPath="url(#z)">
          <motion.path
            ...
            d="m66.991 402.01c0 92.503 74.999 167.5 167.5 167.5 92.497 0 167.5-74.999 167.5-167.5 0-92.497 74.999-167.5 167.5-167.5 92.503 0 167.5 74.999 167.5 167.5h-335"
          />
        </g>
      </motion.svg>
    </div>
